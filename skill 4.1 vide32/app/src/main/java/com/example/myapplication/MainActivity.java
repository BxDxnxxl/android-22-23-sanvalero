...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etiqueta = (TextView) findViewById(R.id.eli1);
    ...
    private void obtenerInfo() {
        ...
        Toast.makeText(getApplication(), "Dato numerico"+ numero, Toast.LENGTH_SHORT).show();
        Toast.makeText(getApplication(), "Dato pass"+ pass, Toast.LENGTH_SHORT).show();
        Toast.makeText(getApplication(), "Dato parrafo"+ parrafo, Toast.LENGTH_SHORT).show();
    }
}